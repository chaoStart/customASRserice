...
ExecStart=/bin/bash ${SCRIPT_DIR}/start_qwen3_asr.sh
Restart=on-failure
RestartSec=10
...
CUDA_VISIBLE_DEVICES="$CUDA_DEVICE_INDEX"  qwen-asr-serve Qwen/Qwen3-ASR-1.7B --gpu-memory-utilization "$CUDA_MEMORY_FRACTION" --host 0.0.0.0 --port 8000
